...
// MintDummy is a paid mutator transaction binding the contract method 0x2f4bcf11.
//
// Solidity: function mintDummy(_to address, _tokenId uint256, _tokenURI string, _anchorId uint256, _merkleRoot bytes32, _values string[], _salts bytes32[], _proofs bytes32[][]) returns()
func (_EthereumPaymentObligationContract *EthereumPaymentObligationContractTransactor) MintDummy(opts *bind.TransactOpts, _to common.Address, _tokenId *big.Int, _tokenURI string, _anchorId *big.Int, _merkleRoot [32]byte, _values []string, _salts [][32]byte, _proofs [][][32]byte) (*types.Transaction, error) {
	return _EthereumPaymentObligationContract.contract.Transact(opts, "mintDummy", _to, _tokenId, _tokenURI, _anchorId, _merkleRoot, _values, _salts, _proofs)
}

// MintDummy is a paid mutator transaction binding the contract method 0x2f4bcf11.
//
// Solidity: function mintDummy(_to address, _tokenId uint256, _tokenURI string, _anchorId uint256, _merkleRoot bytes32, _values string[], _salts bytes32[], _proofs bytes32[][]) returns()
func (_EthereumPaymentObligationContract *EthereumPaymentObligationContractSession) MintDummy(_to common.Address, _tokenId *big.Int, _tokenURI string, _anchorId *big.Int, _merkleRoot [32]byte, _values []string, _salts [][32]byte, _proofs [][][32]byte) (*types.Transaction, error) {
	return _EthereumPaymentObligationContract.Contract.MintDummy(&_EthereumPaymentObligationContract.TransactOpts, _to, _tokenId, _tokenURI, _anchorId, _merkleRoot, _values, _salts, _proofs)
}

// MintDummy is a paid mutator transaction binding the contract method 0x2f4bcf11.
//
// Solidity: function mintDummy(_to address, _tokenId uint256, _tokenURI string, _anchorId uint256, _merkleRoot bytes32, _values string[], _salts bytes32[], _proofs bytes32[][]) returns()
func (_EthereumPaymentObligationContract *EthereumPaymentObligationContractTransactorSession) MintDummy(_to common.Address, _tokenId *big.Int, _tokenURI string, _anchorId *big.Int, _merkleRoot [32]byte, _values []string, _salts [][32]byte, _proofs [][][32]byte) (*types.Transaction, error) {
	return _EthereumPaymentObligationContract.Contract.MintDummy(&_EthereumPaymentObligationContract.TransactOpts, _to, _tokenId, _tokenURI, _anchorId, _merkleRoot, _values, _salts, _proofs)
}
